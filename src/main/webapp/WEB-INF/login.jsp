...
<%--                            <img src="images/cm-main-img.png" alt="">--%>
                    ...
                    <div class="col-lg-6">
                        <div class="login-sec">
                            ...
                            <ul class="sign-control">
                                <li data-tab="tab-1" class="${newUser.username == null ? 'current' : ''}"><a href="#" title=""><spring:message code="login.signin" text="Sign in" /></a></li>
                                <li data-tab="tab-2" class="${newUser.username != null ? 'current' : ''}"><a href="#" title=""><spring:message code="login.signup" text="Sign up" /></a></li>
                            </ul>
                            <div class="${newUser.username == null ? 'sign_in_sec current' : 'sign_in_sec'}" id="tab-1">
...
<%--                                </form:form>--%>
                            ...
                            <div class="${newUser.username != null ? 'sign_in_sec current' : 'sign_in_sec'}" id="tab-2">
                                <div class="dff-tab current" id="tab-3">
                                    <form:form method="post" action="register" modelAttribute="newUser">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 no-pdd pt-4">
                                                <div class="g-recaptcha col-sm-5" data-sitekey="${siteKey}" data-callback="gRecaptchaCallback"></div>
                                            </div>

                                            <div class="col-lg-12 no-pdd">
                                                <button id="signup-btn" type="submit" value="submit" disabled><spring:message code="login.signup" text="Sign up" /></button>
                                            </div>
                                        </div>
                                    </form:form>
                                </div><!--dff-tab end-->
