    <%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <security:authorize access="hasAnyRole('USER','ADMIN','CONTENT_MANAGER')">
        <li>
        ...
        <span><img src="<c:url value='/images'/>/icon8.png" alt=""></span>
        <spring:message code="navbar.report"/>
        </a>
        </li>
        ...
        <security:authorize access="hasAnyRole('ADMIN','CONTENT_MANAGER')">
            ...
            <li>
            <a href="<c:url value='/postCategories/'/>">
            <spring:message code="navbar.postCategories"/>
            </a>
            </li>
        </security:authorize>
        ...
        <li>
            <a href="<c:url value='/login' />">
            	<span><img src="<c:url value='/images'/>/login.png" alt=""></span>
                <spring:message code="login.signin" text="Sign in" /> | <spring:message code="login.signup" text="Sign up" />
            </a>
        </li>
        </c:if>
