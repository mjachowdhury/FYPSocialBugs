...
function validateForm() {
    var valid = true;
    var message = "";
    var text = document.forms["addPostForm"]["text"].value;
    var category = document.forms["addPostForm"]["postCategory"].value;
    var tnc = document.forms["addPostForm"]["acceptTnC"].checked;

    if(!text) {
        message = "Text of the post shouldn't be empty.";
        valid=false;
    } else if(category == 0) {
