...
public class ContentManagement {
    ...
    public void handleUnhealthyPost(JoinPoint jp) {
        ...
        if (!isApproved) {
            ...
            if (noOfDisapprovedPosts >= 2) {
                adminService.setUserEnabled(userId, false);
                // Prepare email to send to deactivated user:
                String emailSubject = "Social-Bugs Social Network - Deactivation Notice";
                String emailBody = "Dear " + user.getProfile().getFirstName() + " " + user.getProfile().getLastName() + ",\n\n" +
                        ...
                        "If you think this is a mistake, please contact us at socialbugs.network@gmail.com. An admin will study your case and will " +
                        "Re-activate your account if you were found correct.\n\n" +
                        "Please accept our apologies for any inconvenience caused.\n\n" +
                        "Best regards,\n\n" +
                        "Social-Bugs Social Network team \n\n\n\n" +
                        "(c) Copyright Social-Bugs Social Network " + LocalDate.now().getYear();
